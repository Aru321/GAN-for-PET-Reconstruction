...
if __name__ == '__main__':
    for i in range(60,80):
        print_heatmap2(i,['./imgs_left/hp033-pet-720-reorient-align-resample.img/',
                           './imgs_left/hp033-pet-180-1-reorient-align-resample.img/',
                           './imgs_left/unetfake_hp033.img/',
                           './imgs_left/transganfake_hp033.img/',
                            './imgs_left/cut_1000.img/'])
