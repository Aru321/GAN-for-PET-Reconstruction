...
class Generator(nn.Module):#A Small Version which is more Memory Friendly
    def __init__(self):
        ...
        self.fuse0 = nn.Conv3d(64*2,64,kernel_size=3,stride=1,padding=1)
        ...
        self.decoder_layer1_up=nn.ConvTranspose3d(256,192,kernel_size=4,stride=2,padding=1)
        #8*8*8
    ...
    def forward(self,x,mri):
        ...
        en0=en0+self.fuse0(torch.cat([en0,mri0],1))
        #print("en0:",en0.shape)
        en1 = self.encoder_layer1_down(en0)
        en1=en1+self.fuse1(en1,mri1)#16*16*16
        #print("en1:",en1.shape)
        #
        en2 = self.encoder_layer2_down(en1)
        en2=en2+self.fuse2(en2,mri2)#8*8*8
        #print("en2:",en2.shape)
